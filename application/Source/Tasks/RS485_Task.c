...
static void rs485_cli_write(const char* message, size_t length, void* context)
{
    (void)context;
...
static const CLI_Channel_t g_rs485_cli_channel = {
    .write = rs485_cli_write,
    .context = NULL
};
...
static RS485_Result_t handle_debug_cmd(const RS485_Frame_t* req, RS485_Frame_t* resp)
{
    ...
    CLI_Execute(cmd, &g_rs485_cli_channel);
