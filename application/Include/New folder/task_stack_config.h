...
#define SD_LOGGER_TASK_STACK_BYTES  (1024u * 4)   /* 4096 bytes - increased to match shared driver (was 3584B) */
...
#define USB_CDC_TASK_STACK_BYTES    (256u * 4)   /* 1024 bytes - increased to match shared driver (was 896B) */
...
#define LCD_DISPLAY_TASK_STACK_BYTES (1024u * 4)  /* 4096 bytes - increased to match shared driver (was 3840B) */
#define LCD_DISPLAY_TASK_STACK_WORDS STACK_BYTES_TO_WORDS(LCD_DISPLAY_TASK_STACK_BYTES)

/* Water Dispenser Task - State machine and valve control (same as CarWash) */
#define DISPENSER_TASK_STACK_BYTES    (512u * 4)   /* 2048 bytes - increased to match shared driver (was 1024B) */
...
#define IO_EXPANDER_TASK_STACK_BYTES (256u * 4)  /* 1024 bytes - increased to match shared driver (was 768B) */
#define IO_EXPANDER_TASK_STACK_WORDS STACK_BYTES_TO_WORDS(IO_EXPANDER_TASK_STACK_BYTES)
#define IO_EXPANDER_CONTROL_TASK_STACK_BYTES IO_EXPANDER_TASK_STACK_BYTES
#define IO_EXPANDER_CONTROL_TASK_STACK_WORDS IO_EXPANDER_TASK_STACK_WORDS
...
/* Water Dispenser Task - Normal priority (same as CarWash) */
...
#define IO_EXPANDER_CONTROL_TASK_PRIORITY IO_EXPANDER_TASK_PRIORITY
