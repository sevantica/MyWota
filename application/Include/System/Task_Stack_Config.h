...
#define LCD_DISPLAY_TASK_STACK_BYTES (1536u * 4)  /* 6144 bytes - Increased for safety */
...
#define DISPENSER_TASK_STACK_BYTES    (1024u * 4)   /* 4096 bytes - Increased for MIFARE crypto ops */
...
#define MIFARE_POLLING_TASK_STACK_BYTES (1024u * 4) /* 4096 bytes - Increased to prevent WDT timeouts */
