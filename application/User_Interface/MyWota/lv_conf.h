 ...
 * INCREASED: Slower refresh to prevent rendering overload with large bars */
 ...
 * - LV_OS_MQX
 * - LV_OS_CUSTOM 
 * DISABLED: Threading disabled to prevent deadlocks in drawing operations */
 ...
 * REDUCED: No threading used, so this setting is less critical but kept for compatibility
 */
...
#define LV_USE_DRAW_SW 1
     ...
     * REDUCED: Fewer threads to prevent memory contention with large bars */
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        * REDUCED: Less caching to save memory for large bars */
...
#define LV_GRADIENT_MAX_STOPS   10
...
#define LV_USE_ILI9488       0

#define LV_USE_GENERIC_MIPI (LV_USE_ST7735 | LV_USE_ST7789 | LV_USE_ST7796 | LV_USE_ILI9341 | LV_USE_ILI9488)
